...
# This is the script that generates plot 1 (histogram of Global Active Power (kw))
library(data.table)
...
#Create the histogram plot (plot 1) and format it properly with title and labels 
with(selData, {
       hist(Global_active_power, col = "green", main = "Global Active Power",
